...
class CodeInput extends Component {
  constructor(props) {
    super(props);
    const { fields, type, isValid, disabled, filterKeyCodes } = props;
    let { value } = props;
    this.state = {
      value,
      fields,
  ...
  handleKeyDown(e) {
    ...
    switch (e.keyCode) {
      ...
      case CODE_INPUT.LEFT_ARROW_KEY:
        e.preventDefault();
        if (prevTarget) {
          prevTarget.focus();
          prevTarget.select();
      ...
      case CODE_INPUT.RIGHT_ARROW_KEY:
        e.preventDefault();
        if (nextTarget) {
          nextTarget.focus();
          nextTarget.select();
      ...
      case CODE_INPUT.UP_ARROW_KEY:
        e.preventDefault();
        break;

      case CODE_INPUT.DOWN_ARROW_KEY:
        e.preventDefault();
        break;

      case CODE_INPUT.E_KEY:
  ...
  render() {
    ...
    return (
      <div
        className={classNames(className, "code-input")}
